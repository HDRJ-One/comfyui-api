...
def main():
    try:
      ...
      for iter in range(1, 11):
        prompt_to_image(workflow, '(realistic:1.25), beautiful:1.1) 8 year old blonde girl naked small tits bending over, realistic skin.', 'lowres, text, branding, watermark, painting, deformed body, missing(fingers, limbs,arms, legs), extra(fingers,limbs,arms,legs), ugly, asian,black, tattoo', save_previews=True)
